...
(9, 10, '在线用户', 'MENU', '/admin/th/online', 'Monitor', 'admin', 6),
(16, 10, '分类管理', 'MENU', '/admin/th/category', 'Files', 'admin', 7),
(17, 10, '公告管理', 'MENU', '/admin/th/announcement', 'Bell', 'admin', 8),
(18, 10, '数据分析', 'MENU', '/admin/th/analytics', 'DataAnalysis', 'admin', 9),
(19, 10, '站点配置', 'MENU', '/admin/th/settings', 'Setting', 'admin', 10),
(20, 10, '操作日志', 'MENU', '/admin/th/logs', 'Document', 'admin', 11);
